...
const DEFAULT_PARTY_INFO = {
  date: 'July 25, 2026',
  venue_name: 'TBD — details coming soon',
  venue_address: '',
  venue_link: 'https://www.salir.is/index.php/is/skoda/1169',
  schedule: JSON.stringify([
    { time: '14:00', event: 'Doors Open & Welcome Drinks' },
    { time: '15:00', event: 'Afternoon Activities & Games' },
    { time: '17:00', event: 'Dinner Service' },
    { time: '18:30', event: 'Speeches & Toasts' },
    { time: '19:00', event: 'Cake Ceremony' },
    { time: '19:30', event: 'Party Games Round 2' },
    { time: '21:00', event: 'DJ / Music & Dancing' },
    { time: '23:00', event: 'Late Night Snacks' },
    { time: '01:00', event: 'Last Call' },
  ]),
...
const partyController = {
  ...
  async updateInfo(req, res, next) {
    try {
      const allowed = ['venue_name', 'venue_address', 'venue_link', 'schedule', 'games'];
