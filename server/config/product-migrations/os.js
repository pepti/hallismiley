...
const OS_003_EDITS = [
  ...
  { slug: 'kerfid-i-stuttu-mali', field: 'body',
    ...
    to: '<p>Þjónustuleiðirnar þrjár (sjá <em>Þrepin þrjú</em>) eru einfaldlega mismunandi stórir skammtar af þessu sama kerfi — ekki þrjár ólíkar vörur. Fyrirtæki sem þarf kerfi smíðað utan um eigin rekstur fer í fjórðu leiðina, <strong>Samstarf</strong>: þar er verðið samið eftir ókeypis mat.</p>' },
  { slug: 'fyrsta-samtalid', field: 'body',
    from: 'Nefndu þrepið sem þér sýnist passa og af hverju. Ef verð ber á góma:',
    to: 'Nefndu þrepið sem þér sýnist passa og af hverju — eða, ef reksturinn þarf kerfi smíðað utan um sig, bjóddu ókeypis mat í stað þreps (sjá <em>Þrepin þrjú</em>, kaflann um Samstarf). Ef verð ber á góma:' },
  ...
  { slug: 'threpin-thrju', field: 'summary',
    ...
    to: 'Vefur, Verslun og Rekstur: uppsetningargjald 390 / 580 / 690 þ.kr. og þjónustusamningur 29 / 59 / 89 þ.kr./mán með 2 / 3 / 5 verkeiningum á mánuði, einingaverð 6.000 kr. umfram það — öll verð DRÖG þar til Halli staðfestir, öll án VSK. Fjórða leiðin, Samstarf, hefur ekkert listaverð: verðið er samið eftir ókeypis mat. Aldrei tímagjald. Hér lærirðu verðmódelið, hvað verkeining er, hvernig þú parar fyrirtæki við rétt þrep og hvenær þú býður ókeypis mat í staðinn.' },
  { slug: 'threpin-thrju', field: 'body',
  ...
  { slug: 'hvad-er-i-hverju-threpi', field: 'summary',
    ...
    to: 'hvað bætist við í Verslun og hvað er aðeins í Rekstri. Samstarf er utan töflunnar: þar ræður ókeypis matið. Þetta er heimildin' },
  { slug: 'hvad-er-i-hverju-threpi', field: 'body',
  ...
  { slug: 'tilbodsferlid', field: 'body',
    ...
    to: '<li><strong>Líklegt þrep:</strong> Vefur, Verslun eða Rekstur, með rökstuðningi í einni setningu — eða <strong>Samstarf</strong>, ef reksturinn þarf kerfi smíðað utan um sig (sjá <em>Þrepin þrjú</em>). Þá er næsta skref ókeypis mat, ekki tilboð beint.</li>' },
  { slug: 'tilbodsferlid', field: 'body',
