...
const DEFAULT_META = {
  en: {
    home:           { title: 'Rekstrarkerfið — Your whole system in one place', description: 'Website, online store, inventory and invoicing in one Icelandic system. One monthly invoice, changes in days not months.' },
    thjonusta:      { title: 'Services & pricing — Rekstrarkerfið', description: 'Three tiers — Vefur, Verslun, Rekstur — from website to full business system. Flat monthly subscription, no hourly billing.' },
    umOkkur:        { title: 'About us — Rekstrarkerfið', description: 'Orange Smiley ehf. is an Icelandic software company: a solo founder assisted by AI agents, building and operating systems for Icelandic SMBs.' },
    projects:       { title: 'Our work — Rekstrarkerfið', description: 'Case studies of systems we have built and operate — including a full Shopify-to-own-platform migration for an Icelandic wholesaler.' },
    ...
    contact:        { title: 'Contact — Rekstrarkerfið', description: 'Get a demo or ask about moving your website, store or business system over. We reply within one business day.' },
    privacy:        { title: 'Privacy Policy — Rekstrarkerfið' },
    terms:          { title: 'Terms of Service — Rekstrarkerfið' },
  ...
  is: {
    home:           { title: 'Rekstrarkerfið — allt kerfið þitt á einum stað', description: 'Vefur, verslun, lager og reikningar í einu íslensku kerfi. Einn mánaðarreikningur, breytingar á dögum ekki mánuðum.' },
    thjonusta:      { title: 'Þjónusta og verð — Rekstrarkerfið', description: 'Þrjár leiðir — Vefur, Verslun, Rekstur — frá heimasíðu upp í heilt rekstrarkerfi. Föst mánaðaráskrift, engir tímareikningar.' },
    umOkkur:        { title: 'Um okkur — Rekstrarkerfið', description: 'Orange Smiley ehf. er íslenskt hugbúnaðarfyrirtæki: einn stofnandi með aðstoð gervigreindarumboða sem smíðar og rekur kerfi fyrir íslensk fyrirtæki.' },
    projects:       { title: 'Verkefnin okkar — Rekstrarkerfið', description: 'Umfjöllun um kerfi sem við höfum smíðað og rekum — þar á meðal flutning íslenskrar heildverslunar af Shopify yfir á eigið kerfi.' },
    ...
    contact:        { title: 'Hafa samband — Rekstrarkerfið', description: 'Fáðu demo eða spurðu um flutning á vef, verslun eða rekstrarkerfi. Við svörum innan eins virks dags.' },
    privacy:        { title: 'Persónuverndarstefna — Rekstrarkerfið' },
    terms:          { title: 'Notkunarskilmálar — Rekstrarkerfið' },
