...
1. Read the `## Status` section in `CLAUDE.md` and the `## Status` section at the end of `PLAN.md` (the dated programme write-ups are in `docs/HISTORY.md`; the per-domain map in `docs/ARCHITECTURE.md`).
