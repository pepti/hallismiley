...
|---|---|---|---|---|---|---|---|
| `admin-2fa` | Tvíþætt auðkenning / Admin 2FA (TOTP) | 1 | engine | live | — | `082_admin_totp` | [admin-2fa.md](admin-2fa.md) |
...
| id | name (is / en) | domain | owner | status | flag | migrations | file |
|---|---|---|---|---|---|---|---|
| `hallismiley-site` | Hallismiley.is — eigin hlutar / hallismiley.is — the site's own pieces | 3 | hs | live | — | — | [hs/hallismiley-site.md](hs/hallismiley-site.md) |
