...
- A text change to `seed-sales-guides.js` ships with a product migration that makes the same change to seeded rows (104, os_001, os_003); `salesGuidesD001.test.js` and `salesGuidesD022.test.js` check the seed and the migrations agree, step by step.
