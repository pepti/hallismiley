...
(function () {
  // hallismiley residual hook (engine-graft): + the base's five colour themes.
  var THEMES  = ['ember', 'classic', 'midnight', 'glacier', 'moss', 'lava', 'aurora', 'black-sand']; // 'light'/'mono' retired 2026-09-02
  var DEFAULT = 'ember';
  var ROOT    = 'classic';
  var theme = null;
  try {
