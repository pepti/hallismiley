...
const VIEWS = {
  ...
  // (features/hs/aron13.md); its meta/noindex/IS lock live in identity.routes.
  Aron13View:               () => import('./views/Aron13View.js').then((m) => m.Aron13View),
};
...
const ROUTES = [
  ...
  // (hallismiley residual hook, engine-graft; known to the server through identity.routes).
  { pattern: '/aron13ara',       factory: async ()  => make('Aron13View') },
