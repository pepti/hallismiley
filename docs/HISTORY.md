...
| 2026-09-26 | [Handbook on D-022 pricing, with the fourth tier Samstarf](#handbook-d022-2026-09-26) | Halli re-priced the service contract (D-022, amends D-001): 29/59/89 þ.kr./mán with 2/3/5 verkeiningar, einingaverð 6.000 kr., hosting and in-system AI beyond the included amount at cost + 15 %; build fees unchanged. Eight seeded guides rewritten; Samstarf (no listed price, agreed after a free assessment) and when a seller offers the assessment; product migration `os_003_sales_guides_d022_pricing`; all DRÖG, guides unpublished |
